...
def CredalRanking(wStar, criteria_name):
  ...
  f.tight_layout()
  ###plt.show()
  plt.savefig('Environmental_1f.jpeg')

  return w


#A_B =  np.array([
#       [7, 1, 4, 3, 3, 6, 5, 8, 3, 3, 2, 2],
#       [1, 2, 3, 4, 5, 5, 6, 7, 7, 8, 8, 9],
#       [7, 7, 6, 6, 7, 6, 6, 6, 7, 7, 7, 8],
#       [3, 1, 2, 7, 4, 4, 4, 7, 3, 2, 2, 3],
#       [3, 5, 1, 5, 1, 4, 4, 6, 3, 4, 2, 2],
#       [5, 4, 3, 2, 1, 7, 4, 6, 3, 5, 3, 2],
#       [3, 2, 1, 3, 2, 5, 5, 4, 1, 2, 2, 2],
#       [9, 2, 2, 6, 1, 4, 5, 7, 3, 2, 2, 2]])
A_B = np.loadtxt('data_ENVIRONMENTAL_Market_A_B.txt')
check1 = np.loadtxt('check_ENVIRONMENTAL_Market_rev.txt')
A_B = A_B[check1==1,:]
print(A_B)

#A_W =  np.array([
#      [ 6, 9, 6, 7, 4, 3, 1, 2, 4, 5, 8, 8],
#      [ 9, 7, 6, 6, 5, 5, 4, 4, 3, 2, 2, 1],
#      [ 8, 7, 7, 8, 8, 7, 7, 8, 7, 8, 8, 8],
#      [ 5, 8, 8, 2, 5, 4, 3, 1, 5, 7, 5, 6],
#      [ 3, 2, 6, 2, 6, 3, 3, 1, 3, 2, 5, 5],
#      [ 3, 4, 5, 6, 7, 1, 4, 2, 5, 3, 5, 6],
#      [ 3, 4, 5, 3, 4, 1, 1, 2, 5, 4, 4, 4],
#      [ 1, 8, 8, 4, 9, 7, 5, 3, 7, 8, 8, 8]])
A_W = np.loadtxt('data_ENVIRONMENTAL_Market_A_W.txt')
check1 = np.loadtxt('check_ENVIRONMENTAL_Market_rev.txt')
A_W = A_W[check1==1,:]
print(A_W)

#criteria_name = {'C1': 0, 'C2':1, 'C3':2, 'C4':3,'C5':4, 'C6':5, 'C7':6, 'C8':7, 'C9':8}
criteria_name = {'E1': 0, 'E2':1, 'E3':2, 'E4':3,'E5':4, 'E6':5, 'E7':6, 'E8':7, 'E9':8}
###criteria_name = {'E1': 1, 'E2':2, 'E3':3, 'E4':4,'E5':5, 'E6':6, 'E7':7, 'E8':8, 'E9':9}
